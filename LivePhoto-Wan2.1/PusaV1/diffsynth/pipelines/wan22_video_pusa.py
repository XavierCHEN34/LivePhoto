...
class Wan22VideoPusaPipeline(BasePipeline):
    ...
    def fetch_models(self, model_manager: ModelManager):
        ...
        if isinstance(dit, list):
            # print(f"dit is a list: {dit}")
            self.dit, self.dit2 = dit

        else:
            # print(f"dit is not a list: {dit}")
            self.dit = dit
    ...
    def from_model_manager(model_manager: ModelManager, torch_dtype=None, device=None, use_usp=False):
        ...
        pipe = Wan22VideoPusaPipeline(device=device, torch_dtype=torch_dtype)
    ...
    def decode_video(self, latents, tiled=True, tile_size=(34, 34), tile_stride=(18, 16)):
        # TODO Ensure latents are on the correct device and dtype
    ...
    def __call__(
        ...
        for progress_id, timestep_val in enumerate(progress_bar_cmd(self.scheduler.timesteps)):
            ...
            # timestep[:,0] = 0 # TODO I2V w/o noise first frame
            # timestep[:,0] = 300 # TODO I2V w/o noise first frame
            # timestep[:,0] = 200 # TODO I2V w/o noise first frame
            # timestep[:,0] = 100 #s TODO I2V w/o noise first frame
            ...
            latents = self.scheduler.step(noise_pred, timestep, latents) #TODO
...
def model_fn_wan_video(
    ...
    **kwargs,
    ...
    # # TODO Ensure input tensor has the same dtype as model parameters
    # x = x.to(dit.patch_embedding.weight.dtype)
    # if y is not None:
    #     y = y.to(dit.patch_embedding.weight.dtype)
    ...
    # TODO Get the dtype and device from the model parameters
